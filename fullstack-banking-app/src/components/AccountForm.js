                ...
                <div className="edit-account-form col-md-6 offset-md-3">
                    ...
                    <Form>
                        ...
                        <Form.Group controlId="acc_no">
                            ...
                            <Form.Control type="text" placeholder="Enter new IFSC code" value={ifsc} onChange={this.handleInputChange}/>
                        </Form.Group>
                        <Button variant="primary" onClick={() => this.handleUpdateAccount(ifsc)}>
                            Update details
                        </Button>
                    </Form>
                </div>
                ...
                <div className="account-form col-md-6 offset-md-3">
                    ...
                    <Form onSubmit={this.handleOnSubmit} className="account-form">
                        ...
                        <Form.Group controlId="amount">
                            ...
                            <Form.Control type="number" placeholder={`Enter amount to ${selectedType}`} value={this.state.amount} onChange={this.handleAmountChange}/>
                        </Form.Group>
